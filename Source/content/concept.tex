...
\begin{figure}[H]
	...
	\caption[Caption for concept]{Grundaufbau eines Schul-Buckets\footnotemark}
	\label{fig:aufbau}
\end{figure}
...
\begin{figure}[H]
	...
	\caption[Caption for concept]{Verteilung der Schul-Buckets mithilfe des Strategy-Patterns\footnotemark}
	\label{fig:strategy}
\end{figure}
\footnotetext{Kiefer 2017}
...
\begin{figure}[H]
	...
	\caption[Caption for concept]{Interaktion zwischen Client, Server und File Storage Provider  beim Holen von persönlichen Dateien\footnotemark}
...
\begin{figure}[H]
	...
	\caption[Caption for concept]{Interaktion zwischen Client, Server und File Storage Provider beim Upload einer Datei\footnotemark}
